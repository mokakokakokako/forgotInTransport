...
import com.miitdiplomasoft.forgotintransport.ui.fragments.SearchFragmentDirections

class SearchGridItemsAdapter(
    private val items: ArrayList<MenuItemResponse>
) : RecyclerView.Adapter<SearchGridItemsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            holder.itemView.findNavController().navigate(SearchFragmentDirections.actionSearchFragmentToCardFragment(item.id!!))
        }
    }
