...
class MenuGridItemsAdapter(
    private val items: ArrayList<MenuItemResponse>
) : RecyclerView.Adapter<MenuGridItemsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            holder.itemView.findNavController().navigate(MenuFragmentDirections.actionMenuFragmentToCardFragment(item.id!!))
        }
    }
